...
#define ISEXFAT(x) _ISEXFAT(x)
#define ISFAT32(x) _ISFAT32(x)
/*
#define _ISFAT32(dpbp)  (((dpbp)->dpb_size)>FAT_MAGIC16 && ((dpbp)->dpb_size)<=FAT_MAGIC32 )
*/
#if WITHEXFAT == 1
#define _ISEXFAT(dpbp)	((((dpbp)->dpb_fatsize)==0)&&((dpbp)->dpb_exsize!=0))
#define _ISFAT32(dpbp)  ((((dpbp)->dpb_fatsize)==0)&&((dpbp)->dpb_exsize==0))
#else
#define _ISEXFAT(dpbp)	0
