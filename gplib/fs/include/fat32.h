...
/* FAT 32-byte Directory Entry structure */
    ...
    {
        INT8U EntryType;
        INT8U SecondaryFlags;
        INT8U Reserved1;
        INT8U NameLength;
        INT16U NameHash;
        INT16U Reserved2;
        INT32U Reserved3;
        INT64U ValidDataLength;
        INT32U FirstCluster;
        INT64U DataLength;
    } ExFATExtDIR;
    ...
    {
        INT8U EntryType;
        INT8U SecondaryCount;
        INT16U SetChecksum;
        INT16U FileAttributes;
        INT16U Reserved1;
        INT32U CreateTimestamp;
        INT32U LastModifiedTimestamp;
        INT32U LastAccessedTimestamp;
        INT8U CreatemsIncrement;
        INT8U LastModmsIncrement;
        INT8U LastAccmsIncrement;
        INT8U Reserved2[9];
    } ExFATMainDIR;
...
#define NOFatChain(x) (x&0x02)	  //1:未使用簇链
#define Allocati(x) (x&0x01)    //1:合理
