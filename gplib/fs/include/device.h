...
#if WITHEXFAT 
	INT64U bpb_exfsize;			/*ExFat volume length*/
	INT32U bpb_exmapbit;			/*Cluster maptable*/
	//INT16U bpb_exvolflags;		/*Volume flags*/
	INT8U  bpb_expertage;			/*used percentage*/
	INT32U bpb_exFAT1Adr;				/*FAT1 Adress*/
	INT32U bpb_exFATLong;				/*FAT table longth*/
	INT32U bpb_exclucount;		/*Cluster Count*/
	INT32U bpb_exmtable;
	INT32U bpb_exmlength;	    
	INT32U bpb_exuptable;
	INT32U bpb_exuplength;
#endif
} bpb;
