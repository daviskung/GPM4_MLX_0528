...
//================================================================//
// CodePacker data partition that contain FAT FS that you want to access through FS
#define USE_NAND_NUM	1
//static INT8U real_part_id_map[USE_NAND_NUM]={0}; // TODO: This file currently fix to use part 0 as FS data area
static INT8U ever_call_CalculateFATArea = 0;
...
void NAND_GetDrvInfo_2(struct DrvInfo* info)
{
	...
	//act_part_id = real_part_id_map[part_id];
	...
	info->nSectors = Nand_part1_size_Get();
	info->nBytesPerSector = 512;
}
