...
// console
#define GPLIB_CONSOLE_EN		1 // when 1, _DRV_L1_UART1 must 1, _DRV_L1_UART2 and other UART must 0
...
// PScaler system module
#define	GPLIB_PSCALER_CMD_TEST_EN       0

// JPEG image encoding/decoding module
//#define GPLIB_JPEG_ENCODE_EN            1 // williamyeo, roy use _DRV_L1_JPEG instead
//#define GPLIB_JPEG_DECODE_EN            1 // williamyeo, roy use _DRV_L1_JPEG instead
...
#define FS_DEV_MAX                      11	//13 if needs to run RAM disk
/* DEV MODE */
#define MSC_EN                          0
#define SD_EN                           1
#define CFC_EN                          0
#define NAND_APP_EN		                1 // To enable nand app area, and read only access through FS and MSDC interface
#define NAND_APP_WRITE_EN               0 // To enable nand app area allow write access through FS and MSDC interface.
                                          // This should 0 when nandrom.
#define NAND1_EN                        1
#define NAND2_EN                        0
#define NAND3_EN                        0
#define USB_NUM                         0
