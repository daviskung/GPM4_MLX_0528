...
//				  int VidBufNum: maximum number of cached video frames.
...
//========================================================
// Function Name : MultiMediaParser_GetVidCurNumberOfVideo
// Syntax        : long MultiMediaParser_GetVidCurNumberOfVideo(const void *hWorkMem);
// Purpose       : Get the current video frame number
// Parameters    : void *hWorkMem: work memory address
// Return        : ready video number
//========================================================
long MultiMediaParser_GetVidCurNumberOfVideo(const void *hWorkMem);
