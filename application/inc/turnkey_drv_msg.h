...
typedef enum
{
    ...
    MSG_AUD_BG_PAUSE_RES,//0x10000115
    MSG_AUD_BG_RESUME_RES,//0x10000116
    MSG_AUD_START_SAMPLES_COUNT,//0x10000117
    MSG_AUD_PLAY_TIME_GET_START,//0x10000118
    MSG_AUD_PLAY_TIME_GET_END,//0x10000119
    MSG_AUD_PLAY_TIME_RES,//0x1000011A
    MSG_AUD_ALL_FILE_ERR,//0x1000011B
    MSG_AUD_DECODE_STOP_UNFINISHED,//0x1000011C
    MSG_AUD_DECODE_STOP_FINISHED,//0x1000011D
    MSG_AUD_PAUSE_WAIT,////0x1000011E
    MSG_AUD_PARSE,////0x1000011F
    MSG_AUD_MAX
} MSG_AUD_ENUM;
