...
INT32S ov7670_sccb_write(INT8U reg, INT8U value)
{
#if SCCB_MODE == SCCB_GPIO
...
INT32S ov7670_sccb_write_table(regval8_t *pTable)
{
	while(1) {
...
void ov7670_cdsp_stream_on(INT32U index, INT32U bufA, INT32U bufB)
{
 ...
 * @return 	none
 */
void ov7670_cdsp_stream_off(void)
{
 ...
 */
drv_l2_sensor_info_t* ov7670_cdsp_get_info(INT32U index)
{
