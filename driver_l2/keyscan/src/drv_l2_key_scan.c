...
#define KEY_UP      IO_D12
#define KEY_LEFT    IO_D5
#define KEY_SELECT  IO_D15
#define KEY_START   IO_D2
#define KEY_DOWN    IO_D13
#define KEY_RIGHT   IO_D3
#define KEY_A       IO_D6
#define KEY_B       IO_D14
...
void key_Scan(void)
{
	...
	IO1_Data = gpio_read_io(KEY_UP);//gpio_read_io(33);
	IO2_Data = gpio_read_io(KEY_LEFT);//gpio_read_io(34);
	IO3_Data = gpio_read_io(KEY_SELECT);//gpio_read_io(35);
	IO4_Data = gpio_read_io(KEY_START);//gpio_read_io(89);
	IO5_Data = gpio_read_io(KEY_DOWN);//gpio_read_io(85);
	IO6_Data = gpio_read_io(KEY_RIGHT);//gpio_read_io(86);
	IO7_Data = gpio_read_io(KEY_A);//gpio_read_io(87);
	IO8_Data = gpio_read_io(KEY_B);//gpio_read_io(88);
