...
typedef void (*USBD_L2_DECTECT_CALLBACK_FUN)(void);
/*********************************************************************
...
#define	   USBD_EP0_IN_ACK_EVENT	            21
#define    USBD_EP0_OUT_READY_EVENT             22
#define    USBD_EP0_STATE_CLEAR_EVENT           23
#define	   USBD_EP0_OUT_NULL_EVENT				24
...
#define	   USBD_BULK_IN_NACK_EVENT				45
#define	   USBD_BULK_OUT_NACK_EVENT				46
#define	   USBD_BULK_89_IN_NACK_EVENT			47
#define	   USBD_BULK_89_OUT_NACK_EVENT			48
...
#define	   USBD_ISO_OUT_DONE_EVENT				81
#define    USBD_ISO_OUT_NACK_EVENT         		82
#define    USBD_ISO_OUT_FAIL_EVENT         		83

#define	   USBD_NONE_EVENT			            0
...
/* Definitions of usb dev insert/remove detect */
#define C_USBDEVICE_DETPIN         IO_A12
#define USB_DEVICE_TASK_QUEUE_MAX     3
#define MSG_USB_DEVICE_INSERT           0x55
#define MSG_USB_DEVICE_REMOVE           0xAA
#define MSG_USB_DEVICE_TMR_TIMEOUT      0x5A
#define MSG_USB_DEVICE_PLUGIN_CHARGER   0xA5
#define C_5MS                       200
#define C_USBD_DETDEBOUNCE_CNT        5//(JC)unit=5ms
#define USBD_USING_TIMER              3

#define MSG_USBBUS_RESET_ISSUED       0x88
...
typedef struct _USBD_USER_PARA_S
{
    INT32U  detpin;
    INT8U   debcnt;
    INT8U   qhandletype;
    INT32U  tmrflag_period;
    INT8U   tmrflagOnOff;
} USBD_USER_PARA_T;
...
extern const INT8U USBD_USER_PARA[];
extern USBD_USER_PARA_T usbd_userpara;
extern INT8U gCBWError;
extern INT8U gcmd_inquiry_stall;

extern INT32S drv_l2_usbd_ctl_init(void);
extern INT32S drv_l2_usbd_ctl_uninit(void);
extern INT32S drv_l2_usbd_create_l2_q_n_thread(void);//(JC)160908
#if _OPERATING_SYSTEM == _OS_UCOS2
extern void drv_l2_usbd_main(void *param);
#elif _OPERATING_SYSTEM == _OS_FREERTOS
extern void drv_l2_usbd_main(void const *param);
#endif
extern void drv_l2_usbd_main_task_exit(void);
...
extern void drv_l2_usbd_register_detect_cbk(void* cbk);
...
extern void drv_l2_usbd_user_tmrisr(void);
extern void drv_l2_usbd_register_userpara(INT8U *dataptr);
extern void drv_l2_usbd_detio_init(void);
#endif  //DRV_L2_USBD_H
