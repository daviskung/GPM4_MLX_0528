...
typedef void (*ISO_AUDIO_FRAME_TRANSFER_DONE)(INT32U event);
typedef void (*GET_SET_INTERFACE)(INT32U video, INT32U audio);
...
extern void drv_l2_usbd_uvc_uninit(void);
extern INT32S drv_l1_usbd_uvc_init(void);
extern void drv_l2_usbd_uvc_config_resolution(INT32U width, INT32U height);
extern void drv_l2_usbd_resigter_uvc_frame_done_cbk(ISO_FRAME_TRANSFER_DONE cbk);
extern void drv_l2_usbd_resigter_uac_frame_done_cbk(ISO_AUDIO_FRAME_TRANSFER_DONE cbk);
extern void drv_l2_usbd_resigter_set_interface_cbk(GET_SET_INTERFACE cbk);
