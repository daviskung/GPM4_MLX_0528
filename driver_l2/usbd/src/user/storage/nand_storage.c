...
static INT8U real_part_id_map[USE_NAND_NUM]={0}; // TODO: This file currently fix to use part 0 as msdc daat area
...
static INT32S drv_l2_msc_nand_stopunit_userfunc(void* priv)
{
    //DBG_PRINT(" ~stopunit uf~ \r\n");
    return 0;
}
...
MDSC_LUN_STORAGE_DRV const gp_msdc_nand0 =
{
    ...
    drv_l2_msc_nand_stopunit_userfunc   //stop lun unit callback
};
