...
#define BULK_NAK_TEST	0

#define BULK_EP12	1
#define BULK_EP89	2
#define USBD_BULKEP	BULK_EP12

typedef	void (*USBDISRHANDLER)(void);

#define I2C_SLAVE_ADDRESS 0x01
#define I2C_XCKGEN_SLAVE_ADDRESS 0x20
...
/********************* Define rEPINF_SETTING bit mask (Offset + 0x028, USB device endpoints interface setting) *****************/
#define MASK_USBD_EPINF_MANUAL_EN			BIT31
#define EP123INF_OFFSET		0				/* EP12 EP3 */
#define EP4INF_OFFSET		4				/* EP4 */
#define EP5INF_OFFSET		8				/* EP5 */
#define EP6INF_OFFSET		12				/* EP6 */
#define EP7INF_OFFSET		16				/* EP7 */
#define EPCINF_OFFSET		20				/* EPC */
...
#define MASK_USBD_EP0_CS_EP0_INOUT_EN		BIT8
...
#define MASK_USBD_NEWEP_IF_EPC_NAK			BIT14	/* EPC_OUT NAK (No enable ISO OUT)interrupt flag */
#define MASK_USBD_NEWEP_IF_EPC_FAIL			BIT13	/* EPC_OUT transaction failed interrupt flag */
#define MASK_USBD_NEWEP_IF_EPCO				BIT12	/* EPC_OUT transaction interrupt flag */
...
#define MASK_USBD_NEWEP_IE_EPC_NAK			BIT14	/* EPC_OUT NAK (No enable ISO OUT)interrupt enable */
#define MASK_USBD_NEWEP_IE_EPC_FAIL			BIT13	/* EPC_OUT transaction failed interrupt enable */
#define MASK_USBD_NEWEP_IE_EPCO				BIT12	/* EPC_OUT transaction interrupt enable */
...
#define MASK_USBD_EP89_CTL_EP9_OUT_DIR		BIT10	//new add
#define MASK_USBD_EP89_CTL_EP8_IN_DIR		BIT9	//new add
#define MASK_USBD_EP89_CTL_EP9_OUT_ENA		BIT8	//new add
#define MASK_USBD_EP89_CTL_EP8_IN_ENA		BIT7	//new add
...
#define MASK_USBD_EP89_CTL_EP89_ENA_CLR		BIT0	/* ENA control clear */
...
#define MASK_USBD_EPAB_CTL_EP11_OUT_DIR		BIT10	//new add
#define MASK_USBD_EPAB_CTL_EP10_IN_DIR		BIT9	//new add
#define MASK_USBD_EPAB_CTL_EP11_OUT_ENA		BIT8	//new add
#define MASK_USBD_EPAB_CTL_EP10_IN_ENA		BIT7	//new add
...
#define MASK_USBD_EPAB_CTL_EPAB_ENA_CLR		BIT0	/* ENA control clear */
...
/********************* Define rEPC_EVENT bit mask (Offset + 0x580, Endpoint C event register) ******/
#define MASK_USBD_EPC_EVENT_DMA_FINISH		BIT4	/* EPC DMA finish */
#define MASK_USBD_EPC_EVENT_NAK				BIT3	/* EPC OUT NAK, when EPC_EN = 0 */
#define MASK_USBD_EPC_EVENT_OUT_NAK			BIT2	/* EPC OUT NAK, when EPC_EN = 1 */
#define MASK_USBD_EPC_EVENT_PKT_READY		BIT1	/* EPC ISO OUT packet ready */
#define MASK_USBD_EPC_EVENT_OUT_EN			BIT0	/* EPC ISO OUT enable */

/********************* Define rEPC_CTRL bit mask (Offset + 0x584, Endpoint C control register) ******/
#define MASK_USBD_EPC_CTL_RWPTR_CLR			BIT3	/* EPC read/write pointer clear */
#define MASK_USBD_EPC_CTL_AISO_DMA_EN		BIT0	/* Audio ISO OUT DAM enable */
...
#define USBD_BULK_EP1289AB_DMA_NORMAL	0
#define USBD_BULK_EP12_DMA_OUT		1
#define USBD_BULK_EP12_DMA_IN		2
#define USBD_BULK_EP89_DMA_OUT		4
#define USBD_BULK_EP89_DMA_IN		5
#define USBD_BULK_EPAB_DMA_OUT		7
#define USBD_BULK_EPAB_DMA_IN		8
#define USBD_ISO_EPC_DMA_OUT		9
...
**********************************************************************/
/************** USBD API *****************************/
extern INT32S drv_l1_usbd_enable_isr(void);
...
extern void drv_l1_usbd_uphy_suspend(INT8U do_suspend);
/************** USBD EP0 API *************************/
...
extern void drv_l1_usbd_disable_ep0(void);
/************** USBD BULK API *************************/
...
extern void drv_l1_usbd_disable_bulk89_in_out(void);
...
extern void drv_l1_usbd_epc_dma_iso_out(void*buf, INT32U len);
extern void drv_l1_disable_epc_iso_out_nack_event(void);
extern void drv_l1_enable_epc_iso_out_nack_event(void);
extern void drv_l1_disable_epc_iso_out_fail_event(void);
extern void drv_l1_enable_epc_iso_out_fail_event(void);
extern void drv_l1_usbd_enable_epc_iso_out(void);
extern INT32U drv_l1_usbd_get_epc_write_cnt(void);
extern void drv_l1_usbd_get_epc_data(void* buf, INT32U len);
extern INT32U drv_l1_usbd_get_altif_num(INT32U infnum);
extern void drv_l1_usbd_iso_ep7_in(void* buf, INT32U len);
extern void drv_l1_usbd_disable_iso_ep7_in(void);
...
extern void drv_l1_usbd_set_l1tol2_msg_type(INT32U type);
