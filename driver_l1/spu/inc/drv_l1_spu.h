...
#define VIC_SPI0		    13
#define VIC_UART			14
#if 1//(defined MCU_VERSION) && ((MCU_VERSION == GPL326XXB) || (MCU_VERSION == GP326XXXA))
	#define VIC_SD1				15
#else
	#define VIC_CF				15
#endif
...
// bit[8] : 1: Enable sync function with DAC I2S, 0: Disable sync function with DAC I2S
#define C_PW_I2S_SYNC				        0x0100
// bit[9] : reserved
...
// P_SPU_CONTROL_FLAG2 (0xD0400EF4)
// bit[13] : Signed PCM 16 mode control register
#define C_SIGNED_ENABLE					0x2000
...
extern INT32S SPU_System_Colok_Set(INT32U Mclk);
extern void SPU_Uninit(void);
...
extern void SPU_SignedPCM16ON(void);
extern void SPU_SignedPCM16OFF(void);
//channel status
...
extern void SPU_EnablePostWaveI2SSync(void);
extern void SPU_DisablePostWaveI2SSync(void);
#if 1 // williamyeo added
extern INT8U SPU_GetPostWaveI2SSync(void);
extern void SPU_SetI2SSyncSampleRate(INT32U sampleRate);
extern INT32U SPU_GetI2SSyncSampleRate(void);
#endif
