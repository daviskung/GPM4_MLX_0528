...
extern void drv_l1_dac_uninit(void);
...
#if 1
extern INT32S drv_l1_dac_cha_dbf_put(INT16S *data,INT32U len, osMessageQId os_q);
#else
...
extern void drv_l1_dac_hw_up_sample_set(INT32U up_sample_rate);
extern void drv_l1_dac_hw_up_sample_uninit(void);
