...
#define	C_SCALER_CTRL_IN_VYUY				0x10000005
...
#define	C_SCALER_CTRL_IN_VYUY8X32			0x10100006
#define	C_SCALER_CTRL_IN_VYUY8X64			0x10100007
#define	C_SCALER_CTRL_IN_VYUY16X32			0x10200006
#define	C_SCALER_CTRL_IN_VYUY16X64			0x10200007
#define	C_SCALER_CTRL_IN_VYUY32X32			0x10000006
#define	C_SCALER_CTRL_IN_VYUY64X64			0x10000007
...
#define	C_SCALER_CTRL_IN_ARGB4444			0x0000000F
#define	C_SCALER_CTRL_IN_ARGB8888			0x2000000F
#define	C_SCALER_CTRL_IN_ARGB4444X32		0x00000106
#define	C_SCALER_CTRL_IN_ARGB4444X64		0x00000107
#define	C_SCALER_CTRL_IN_MASK				0x3030000F
...
#define	C_SCALER_CTRL_OUT_VYUY				0x10000050
...
#define	C_SCALER_CTRL_OUT_VYUY8X32			0x10040060
#define	C_SCALER_CTRL_OUT_VYUY8X64			0x10040070
#define	C_SCALER_CTRL_OUT_VYUY16X32			0x10080060
#define	C_SCALER_CTRL_OUT_VYUY16X64			0x10080070
#define	C_SCALER_CTRL_OUT_VYUY32X32			0x10000060
#define	C_SCALER_CTRL_OUT_VYUY64X64			0x10000070
...
#define	C_SCALER_CTRL_OUT_ARGB4444			0x000000F0
#define	C_SCALER_CTRL_OUT_ARGB8888			0x400000F0
#define	C_SCALER_CTRL_OUT_ARGB4444X32		0x00001060
#define	C_SCALER_CTRL_OUT_ARGB4444X64		0x00001070
#define	C_SCALER_CTRL_OUT_Y_ONLY_INTEGRAL	0x000010C0
#define	C_SCALER_CTRL_OUT_MASK				0x500C00F0
...
#define	C_SCALER_NEW_INPUT_COLOR_MODE		0x00000100
#define	C_SCALER_NEW_OUTPUT_COLOR_MODE		0x00001000
#define	C_SCALER_NEW_INTEGRATION_MODE0      0x00000000
#define	C_SCALER_NEW_INTEGRATION_MODE1      0x00010000
#define	C_SCALER_NEW_INTEGRATION_MODE3      0x00030000
#define	C_SCALER_NEW_INTEGRATION_MODE_MASK  0x00030000
...
typedef struct {
	INT32U A11;  	/* 0x000:0, 0x080:0.5, 0x380:-0.5, 0x100:1,0, 0x300:-1.0 */
    INT32U A12;		/* 0x000:0, 0x080:0.5, 0x380:-0.5, 0x100:1,0, 0x300:-1.0 */
    INT32U A13;		/* 0x000:0, 0x080:0.5, 0x380:-0.5, 0x100:1,0, 0x300:-1.0 */
    INT32U A21;		/* 0x000:0, 0x080:0.5, 0x380:-0.5, 0x100:1,0, 0x300:-1.0 */
    INT32U A22;		/* 0x000:0, 0x080:0.5, 0x380:-0.5, 0x100:1,0, 0x300:-1.0 */
    INT32U A23;		/* 0x000:0, 0x080:0.5, 0x380:-0.5, 0x100:1,0, 0x300:-1.0 */
    INT32U A31;		/* 0x000:0, 0x080:0.5, 0x380:-0.5, 0x100:1,0, 0x300:-1.0 */
    INT32U A32;		/* 0x000:0, 0x080:0.5, 0x380:-0.5, 0x100:1,0, 0x300:-1.0 */
    INT32U A33;		/* 0x000:0, 0x080:0.5, 0x380:-0.5, 0x100:1,0, 0x300:-1.0 */
} COLOR_MATRIX_CFG;
...
/*
* Function Name :  drv_l1_scaler_output_addr_get
*
* Syntax : INT32S drv_l1_scaler_output_addr_get(INT32U *y_addr, INT32U *u_addr, INT32U *v_addr);
*
* Purpose :  Get output image address.
*
* Parameters : <IN> y_addr:	Start address of output Y data
*										u_addr:	Start address of output U data
*										v_addr:	Start address of output V data
...
*
*/
extern INT32S drv_l1_scaler_output_addr_get(INT8U scaler_num, INT32U *y_addr, INT32U *u_addr, INT32U *v_addr);
/*
